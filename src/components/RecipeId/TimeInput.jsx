  ...
  render() {
    return (
      <React.Fragment>
        ...
        {this.state.isDisplayingDialog ? <ClickToStartCooking openDialog={this.state.isDisplayingDialog}/>: null}
      </React.Fragment>
    );
  }
}
...
const mapDispatchToProps = dispatch => {
  return {
    sendInputTimetoStore: inputTime =>
      dispatch(eatingInputTimeAction(inputTime))
  };
};
